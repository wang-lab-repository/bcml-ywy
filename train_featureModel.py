...
parser.add_argument('--train_data', default='train_data.csv', type=str, help='train data file name')
parser.add_argument('--test_data', default='test_data.csv', type=str, help='test data file name')
...
def start_train(
    ...
    model = BertCNNFeature(drop_out=True,model_path = './bert-base-chinese')
    ...
    emo_dataset = emotionDataset(csv_file_path=data_path, model_path = './bert-base-chinese',max_len=max_len)
    ...
    emo_test_dataset = emotionDataset(csv_file_path=test_data_path, model_path='./bert-base-chinese', max_len=max_len)
