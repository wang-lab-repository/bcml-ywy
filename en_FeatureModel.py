...
class BertCNNFeature_en(nn.Module):
    def __init__(self,num_labels = 3,squence_length = 256,model_path = '../bert-base-uncased',drop_out=True):
        super(BertCNNFeature_en, self).__init__()
        ...
        self.is_drop = drop_out #train的时候设为true  test时设为false
    ...
    def forward(self, input_data, token_type_ids=None, attention_mask=None, labels=None,
        ...
        logits = self.classifier(combined_features) # [batch_size,num_label]
