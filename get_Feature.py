...
parser.add_argument('--model_pt_path', default='checkpoint/Emotion/epoch10_3/', type=str, help='model pt path')
...
parser.add_argument('--train_data', default='shuffled_data.csv', type=str, help='data ')
...
def start_train(
    ...
    model = ws_Feature(drop_out=True,model_path = './bert-base-chinese')
    ...
    # 保存到CSV文件
    all_data_df.to_csv('features.csv', index=False)
